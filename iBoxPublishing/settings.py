...
ALLOWED_HOSTS = ['*']
CSRF_TRUSTED_ORIGINS = ['https://iboxpublishing.up.railway.app']
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = 'iBoxPublishing Admin'
EMAIL_HOST_USER = 'officialpatchwork07@gmail.com'  # Your Gmail email address
EMAIL_HOST_PASSWORD = 'ijjg tgol ldpo mmvw'  # Your Gmail app password or regular password
